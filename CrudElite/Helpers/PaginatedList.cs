...
public class PaginatedList<T> : List<T>
{
                                                           ...
                                                           string searchMessage)
    {
        ...
        return new(items, count, pageIndex, pageSize, total, headers, searchMessage);
    }
}
...
public class ColumnHeader
{
    ...
    /// <summary>
    /// Specifies the sorting order for the column. Append '-asc' for ascending order or '-desc' for descending order. For example, 'TicketTitle-asc' sorts by ticket title
    /// in ascending order,while 'TicketTitle-desc' sorts by ticket title in descending order.
    /// </summary>
    ...
    /// <summary>
    /// Indicates whether the column is sortable. For example, columns containing interactive elements such as edit and delete buttons are not sortable and should be set to
    /// false so that the user cannot apply sort action to the column.
    /// </summary>
    public bool Sortable { get; set; }

    /// <summary>
    /// Indicates whether the column is exportable to PDF. For example, columns containing interactive elements such as edit/delete buttons are not exportable and should be
    /// set to false.
    /// </summary>
