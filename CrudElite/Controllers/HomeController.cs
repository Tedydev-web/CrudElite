...
using CrudElite.Data;
using CrudElite.Helpers;
using CrudElite.Models;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace CrudElite.Controllers;
...
public class HomeController : Controller
{
    ...
    {
        var nameFound = false;
        nameFound = string.IsNullOrEmpty(model.Id) ? _db.Clients.Any(a => a.Name == model.Name) : _db.Clients.Any(a => a.Name == model.Name && a.Id != model.Id);
        var emailFound = false;
        emailFound = string.IsNullOrEmpty(model.Id)
                         ? _db.Clients.Any(a => a.EmailAddress == model.EmailAddress)
